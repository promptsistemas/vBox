...
type
  TFD_PESQUISA = class(TForm)
    ...
    procedure DG_PESQUISADrawColumnCell(Sender: TObject; const Rect: TRect;
...
begin
  frmMenu.bPesquisa := True;
  frmMenu.sNovo := frmmenu.sNovoAnt;
  Close;
end;
...
procedure TFD_PESQUISA.DG_PESQUISADrawColumnCell(Sender: TObject;
  const Rect: TRect; DataCol: Integer; Column: TColumn;
  State: TGridDrawState);
begin
  TDbGrid(Sender).Canvas.font.Color:= clBlue; //aqui é definida a cor da fonte
