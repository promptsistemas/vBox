...
{$ENDIF}
  , uCadCliente
  , U_LIB, UD_PESQUISA, uDM, uCadMotorista;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        DM.cdsClienteNOME.AsString := ACBrConsultaCPF1.Nome;
        DM.cdsClienteDT_FUNDACAO.AsString := ACBrConsultaCPF1.DataNascimento;
      ...
      if ClienteVendedor = 'Motorista' then
      begin

        DM.cdsMotoristaNOME.AsString := ACBrConsultaCPF1.Nome;
...
begin
  ...
  if ClienteVendedor = 'Motorista' then
  begin
    EditCNPJ.Text := frmCadMotorista.DBEdit1.Text;
    EditDtNasc.SetFocus;
  end;
